...
# $Header: /var/cvsroot/gentoo-x86/app-editors/emacs-vcs/Attic/emacs-vcs-24.0.50_pre20110116.ebuild,v 1.3 2011/02/10 20:09:59 ulm dead $
...
if [ "${PV##*.}" = "9999" ]; then
	...
	SRC_URI="mirror://gentoo/emacs-${PV}.tar.bz2"
